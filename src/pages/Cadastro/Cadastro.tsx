...
export default function Cadastro() {
    ...
    const [propsModalDeErroOuSucesso, setPropsModalDeErroOuSucesso] = useState<{ exibir: boolean; titulo: string; corpo: string; }>({ exibir: false, tiulo: "", corpo: "" });
                    ...
                    <div className="box_cadastro">
                        <div className="cadastro_coluna1">
                            <div className="Produtos">
                                ...
                                <input className="input_produtos" type="text" name="" id="produtos" />
                            </div>

                            <div className="categoria_img">
                                <div className="categoria">
                                    <label htmlFor="cat">Categoria</label>
                                    <input className="input_categoria" type="text" name="" id="cat" />
                                </div>
                                <div className="img">
                                    <label htmlFor="img">
                                        <span>Imagem</span>
                    ...
                    <table>
                        <thead>
                            <tr>
                                <th>Produtos</th>
                                <th>Categoria</th>
                                <th className="secao_descrição">Descrição</th>
                                <th>Excluir</th>
                            </tr>
                        </thead>
                        <tbody>
                            {
                                skinCare.map((sk: SkinCare) => (
                                    <tr key={sk.id}>
                                        ...
                                        <td className="secao_descrição" data-cell="Descrição: ">{sk.descricao || "Não informada"}</td>
